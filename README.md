# Bowling_Mega_Mix_PNP
A version of Bowling_Mega_Mix that can run on pinball or pachinko tables like the p^3/p3 pinball table. 

This is only a BackBone port so some changes may be neccessary.
